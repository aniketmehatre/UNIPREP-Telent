...
const prod_uni_apply_b2c_url =
  "http://uniapply.ai/auth/login?redirect=/pages/applications";
const dev_uni_apply_student = "http://74.225.142.9/uniapplyStudents/public/api";
const prod_uni_apply_student =
  "https://apply.uniabroad.io/uniapplyStudents/public/api";
