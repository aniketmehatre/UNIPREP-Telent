...
import {
    PlagCheckResponse,
    SopDocUploadResponse,
    VerifyPlagPayload,
    VerifyResponse
} from "../../../@Models/sop-response.model";
...
export class SopStoreService {
    ...
    selectOptions(params: {docId: number;university: number;country: number;course: string;}): Observable<SopDocUploadResponse> {
