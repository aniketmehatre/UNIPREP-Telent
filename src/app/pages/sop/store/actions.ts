...
export const uploadDocSuccess = createAction('[SOP DOC] upload doc success', (payload: {
    data: SopDocUploadResponse
}) => payload);

export const updateDoc = createAction('[SOP DOC] update doc', (payload: { docId: number, data: string }) => payload);
export const updateDocSuccess = createAction('[SOP DOC] update doc success', (payload: {
    data: SopDocUploadResponse
}) => payload);

export const selectOptions = createAction('[SOP DOC] Select options doc');
export const selectOptionsSuccess = createAction('[SOP DOC] Select options success', (payload: {
    data: SopDocUploadResponse
}) => payload);

export const loadCourse = createAction('[SOP DOC] load course');
export const loadCourseSuccess = createAction('[SOP DOC] load course success', (payload: {
    data: Course[]
}) => payload);

export const loadCountries = createAction('[SOP DOC] load countries');
export const loadCountriesSuccess = createAction('[SOP DOC] load countries success', (payload: {
    data: Country[]
}) => payload);

export const loadUnivercityByCountry = createAction('[SOP DOC] load univercity by country', (payload: {
    id: number
}) => payload);
export const loadUnivercityByCountrySuccess = createAction('[SOP DOC] load univercity by country success', (payload: {
    data: Univercity[]
}) => payload);
...
export const verifyPlagSuccess = createAction('[SOP DOC] verify plag success', (payload: {
    data: SopDocUploadResponse
}) => payload);
