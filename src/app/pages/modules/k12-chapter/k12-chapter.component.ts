...
export class K12ChapterComponent implements OnInit {
    ...
    constructor(private moduleListService: ModuleServiceService, private router: Router, private dataService: DataService,
        ...
        this.subName = this.storage.get('subject-name');
    ...
    loadModuleAndSubModule() {
        ...
        let data: any = {
            ...
            category_id: Number(this.subjectId),
            country_id: 0
        }
    ...
    onSubModuleClick(id: any, submodule: any) {
        this.router.navigate([`/pages/modules/k12-category/question-list/${submodule.submodule_id}`]);
    }
