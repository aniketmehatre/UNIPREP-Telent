...
export class ListSubModulesComponent implements OnInit {
  ...
  updateMetaTags() {
    ...
    this.meta.updateTag({
      name: "og:image",
      content: `https://dev-student.uniprep.ai/uniprep-assets/images/f1.png`,
    });
    this.meta.updateTag({
      name: "og:logo",
      content: `https://dev-student.uniprep.ai/uniprep-assets/images/f1.png`,
  ...
  ngOnInit() {
    ...
    localStorage.setItem(
      "modalcountryid",
      this.quizmoduleselectcountryidsetzero
    );
    this.init();
    this.moduleListService
    ...
    switch (this.currentModuleSlug) {
      case "pre-admission":
        ...
        (this.infoMessage = "Upgrade to access the Pre-admission section"),
          (this.unlockMessage =
            "Unlock the power of success with our exclusive Pre-admission!"),
          (this.upgradePlanMsg =
            "Upgrade your plan now to gain instant access.");
        (this.aboutModule = "Explore a vast database of Q&A about:"),
          (this.moduleDetails =
            "Scholarships, document checklist, Education loan, letter of Recommendation and many more!");
        this.howItWorksVideoLink =
          "https://www.youtube.com/embed/aR06d8kMeio?si=-5Ivte_5ZgdcndS-";
        this.description =
          "Prepare effectively for college with information on entrance requirements, application tips, and more.";
        break;
      case "travel-and-tourism":
        ...
        (this.infoMessage = "Upgrade to access the travel-and-tourism"),
          (this.unlockMessage =
            "Unlock the power of success with our exclusive travel-and-tourism!"),
          (this.upgradePlanMsg =
            "Upgrade your plan now to gain instant access.");
        (this.aboutModule = "Explore a vast database of Q&A about:"),
          (this.moduleDetails =
            "Visa, departure, healthcare, tuition fees and many more!");
        this.howItWorksVideoLink =
          "https://www.youtube.com/embed/PZERtrH1zh8?si=zKQ80B27zz6V9-mk";
        this.description =
          "Discover travel destinations, tips, and essential travel information.";
        break;
      case "post-admission":
        ...
        (this.infoMessage = "Upgrade to access the post-admission"),
          (this.unlockMessage =
            "Unlock the power of success with our exclusive post-admission!"),
          (this.upgradePlanMsg =
            "Upgrade your plan now to gain instant access.");
        (this.aboutModule = "Post-admission offers information about:"),
          (this.moduleDetails =
            " Arrival, student discounts, banking, full time jobs, post study work and many more!");
        this.howItWorksVideoLink =
          "https://www.youtube.com/embed/g_KWlnmOEtc?si=KFpkpjdYMwkCIOV1";
        this.description =
          "Find guidance on navigating your new academic environment after securing admission.";
        break;
      case "career-hub":
        ...
        (this.aboutModule = "Explore a vast database of Q&A about:"),
          (this.moduleDetails =
            " Arrival, student discounts, banking, full time jobs, post study work and many more!");
        this.howItWorksVideoLink =
          "https://www.youtube.com/embed/dBNASRavBk0?si=M2WtoOTl3ahORz8V";
        this.description =
          "Discover career opportunities and get resources to help you plan your professional path.";
        break;
      case "university":
        ...
        this.howItWorksVideoLink =
          "https://www.youtube.com/embed/6mukBsCTgtw?si=aFBa9JMWI2k2QuzP";
        this.description =
          "Explore detailed profiles of universities worldwide, including programs, campus life, and application processes.";
        break;
      case "skill-mastery":
        ...
        (this.aboutModule = "Explore a vast database of Q&A about:"),
          (this.moduleDetails =
            " Arrival, student discounts, banking, full time jobs, post study work and many more!");
        this.howItWorksVideoLink =
          "https://www.youtube.com/embed/mzyfeeL1b4Y?si=SYUFI6bW4xU-QZbT";
        this.description =
          "Enhance your expertise in soft skills through targeted courses and assessments.";
        break;
      case "learning-hub":
        ...
        (this.infoMessage = "Upgrade to access the Learning Hub"),
          (this.unlockMessage =
            "Unlock the power of success with our exclusive Learning Hub!"),
          (this.upgradePlanMsg =
            "Upgrade your plan now to gain instant access.");
        (this.aboutModule = "Explore a vast database of Q&A about:"),
          (this.moduleDetails =
            "Scholarships, document checklist, Education loan, letter of Recommendation and many more!");
        this.howItWorksVideoLink =
          "https://www.youtube.com/embed/prvvJsgnya8?si=QSAeOB9qPMF-ya-D";
        this.description =
          "Upskill with over 1000 specializations across various industries";
        break;
      case "k12-category":
        ...
        (this.infoMessage = "Upgrade to access the K12"),
          (this.unlockMessage =
            "Unlock the power of success with our exclusive k12!"),
          (this.upgradePlanMsg =
            "Upgrade your plan now to gain instant access.");
        (this.aboutModule = "Explore a vast database of Q&A about:"),
          (this.moduleDetails =
            "Scholarships, document checklist, Education loan, letter of Recommendation and many more!");
        this.howItWorksVideoLink =
          "https://www.youtube.com/embed/Zh4pPEZ160c?si=i8vkRTgh70TuoqDn";
        this.description =
          "Explore curriculum-focused content and resources for students in Grades 9 through 12.";
        break;
      default:
        ...
        this.currentApiSlug = "SubmoduleListForStudents";
        (this.infoMessage =
          "Upgrade to access information about life in your chosen destination"),
          (this.unlockMessage =
            "Unlock the power of success with our exclusive destination"),
          (this.upgradePlanMsg =
            "Upgrade your plan now to gain instant access.");
        (this.aboutModule = "Explore a vast database of Q&A about:"),
          (this.moduleDetails =
            "Festivals, events, currency, budget, housing and many more!"),
          (this.selectedModule = "life-at-country");
        this.howItWorksVideoLink =
          "https://www.youtube.com/embed/7VFZp47tfLU?si=GPLVjR5vKlNno-cZ";
    ...
    this.quizList$.subscribe((data) => {
      if (data) {
        this.quizData = data.map((val: any) => {
          let moduleData = this.moduleList.filter(
            (ind) => ind.id == val.module_id
          )[0]!.module_name;
          let subModuleName = this.subModuleList.filter(
            (ind) => ind.id == val.submodule_id
          )[0]!.submodule_name;
          let number = 1;
          let dd = { ...val };
  ...
  nextModule() {
    this.router.navigateByUrl(
      `/pages/modules/${this.currentModuleSlug}/question-list`
    );
  }
  ...
  runQuiz() {
    ...
    this.breadCrumb = [
      { label: cName },
      { label: this.quizData[0]!.module_name },
  ...
  clickPreviousQuiz(carouselQuiz: any, event: any) {
    ...
    this.breadCrumb = [
      { label: cName },
      { label: singleQuizData.module_name },
  ...
  closeQuiz() {
    this.confirmationService.confirm({
      message:
        "Are you sure you want to Quit, All your current progress will be lost.",
      header: "Confirmation",
  ...
  onSubModuleClick(id: any, submodule: any) {
    ...
    if (this.currentModuleId == 14) {
      if (submodule.submodule_name) {
        ...
        this.router.navigate([
          `/pages/modules/${this.currentModuleSlug}/question-list/${submodule.submodule_id}`,
        ]);
        return;
      }
      let data: any = {
    ...
    if (this.currentModuleId == 8 && !this.canShowQuestionList) {
      let data: any = {
        moduleId: this.currentModuleId,
        category_id: this.subModuleList.find((list) => list.submodule_id == id)
          ?.category_id,
      };
    ...
    this.router.navigate([
      `/pages/modules/${this.currentModuleSlug}/question-list/${this.selectedSubModule}`,
    ]);
  }
    ...
    if (this.searchLearning) {
      this.filteredData = this.allSearchedResult
        .filter(
          (item: any) =>
            item.submodule_name
              .toLowerCase()
              .includes(this.searchLearning.toLowerCase()) ||
            item.category_name
              .toLowerCase()
              .includes(this.searchLearning.toLowerCase())
        )
      ...
      this.filteredData = searchData
        .filter((item: any) =>
          item.submodule_name
            ?.toLowerCase()
            .includes(this.searchUniversity.toLowerCase())
        )
        .map((item) => ({
  ...
  selectSearchResult(selectedItem: any) {
    const selectedModule = this.subModuleList.find(
      (item) =>
        item.submodule_id === selectedItem.submodule_id ||
        item.submodule_name === selectedItem.title
    );
    if (selectedModule) {
  ...
  takeMeToQuestion(data: any) {
    this.router.navigate([
      `/pages/modules/learning-hub/question-list/${data.submodule_id}`,
    ]);
  }
