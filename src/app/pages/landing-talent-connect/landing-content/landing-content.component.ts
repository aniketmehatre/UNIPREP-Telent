...
export class LandingContentComponent implements OnInit {
  ...
  steps = [
    ...
    {
      id: 3,
      title: 'Apply for Roles that Match Your Goals',
      description: 'Apply only to roles that align with your skills, interests, and career goals for a perfect job fit.',
    ...
    },
    {
      ...
      description: 'Increase your chances of getting noticed and shortlisted by employers with a profile that stands out.',
