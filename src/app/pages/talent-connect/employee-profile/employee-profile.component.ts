...
export class EmployeeProfileComponent implements OnInit {
  ...
  hoverMessages: any = {
    ...
    date_of_birth: "Enter your date of birth in dd/mm/yyyy format. Employers may refer to this when considering your application, so ensure it matches your official documents.",
    gender: "Select your gender from the options provided. This information helps employers foster inclusive hiring practices while respecting your privacy.",
    nationality_id: "Choose your nationality. This will help employers understand your legal eligibility to work in specific regions or countries.",
    location_id: "Select your current location, including the city and country you reside in. This will help employers match you with nearby opportunities.",
    profile_image: "Upload a professional photo of yourself in jpg format. This helps create a more personal connection with employers and enhances the chances of being noticed.",

    // Education
    education_qualification_id: "Select your highest qualification – this is key for employers to assess your skills and expertise. A complete and accurate education history can significantly boost your chances of standing out to employers and getting noticed for the right roles.",
    education_university_name: "Enter the name of the university or institution where you completed your highest qualification. This will give employers insight into your educational background. Numbers and special characters are not allowed.",
    education_field_id: "Choose the field of study or major you pursued. Providing this information accurately makes your profile more compelling and increases your chances of being selected.",
    education_course_name: "Be specific about the course you completed. Employers are more likely to shortlist candidates with clear, detailed academic backgrounds. Numbers and special characters are not allowed.",
    education_graduation_year_id: "Select the year you graduated. A complete and up-to-date profile will increase your chances of being contacted for relevant roles!",
    education_gpa_percentage: "Enter your GPA or percentage as per your academic grading system. This helps employers assess your academic performance and achievements. The system allows a maximum of two digits followed by the % symbol (for percentage) or numeric entry (for GPA).",

    // Work Experience
    total_years_of_experience: "Select the total years of professional experience you've gained. Employers are looking for candidates with relevant experience. The more experience you have, the better your chances of getting hired!",
    work_experience_company_name: "Enter the name of the company or organisation you have worked for. This provides employers with insight into your previous work environment.",
    ...
    work_experience_experience_letter: "Upload the experience letter/offer letter in pdf and all image format from your previous employer to validate your work experience. This will provide further credibility to your profile.",

    // Career Preferences
    career_preference_career_status: "Select your current career status. Employers need to know your availability to determine if you're the right fit for the role. An updated career status helps match you with opportunities that align with your current situation.",
    career_preference_job_title_id: "Select the job title you're seeking. This helps employers match you with the most relevant positions. Be specific to increase your chances of getting noticed for the right roles.",
    career_preference_career_interest_id: "Select the industry you're most interested in. Aligning your career interest with the right industry helps employers find you more easily.",
    career_preference_preferred_work_location_id: "Select the industry you're most interested in. Aligning your career interest with the right industry helps employers find you more easily.",
    career_preference_preferred_employment_type: "Select your preferred employment type. Being specific helps employers match you with the best opportunities, increasing your chances of landing a role that fits your career goals.",
    career_preference_preferred_workplace_type: "Choose your ideal workplace type. The more specific you are, the better employers can match you with opportunities, increasing your chances of getting hired for the role that suits you best.",
    career_preference_willingness_to_relocate: "Let employers know if you're willing to relocate. Being open to relocation can increase your chances of being considered for a wider range of opportunities.",
    career_preference_expected_salary: "Enter your expected salary range. This helps employers assess if your compensation expectations align with their budget.",
    career_preference_currency_id: "Enter your expected salary range in numbers up to 6 digits. This helps employers assess if your compensation expectations align with their budget.",

    // Certifications & Achievements
    certifications_certificate_name: "List any certifications you've earned (max 50 characters). Showcasing your qualifications helps your profile stand out and increases your chances of being selected for roles requiring specialized skills. Alphanumeric characters are allowed.",
    certifications_certificate_file: "Upload the relevant certification document in Pdf, and all image format",
    certifications_achievement_name: "Highlight your key accomplishments in 50 characters to demonstrate your value. Including relevant achievements can set you apart from other candidates and increase your chances of attracting the attention of employers.",
    certifications_achievement_file: "Upload supporting documents related to your achievements in Pdf, and all image format",

    // Languages & Skills
    languages_language_id: "List the languages you know and your proficiency level. Employers value multilingual candidates, and listing your language skills can improve your chances of being considered for international or diverse roles.",
    languages_proficiency: "Select your proficiency level to showcase your communication skills. This helps employers assess your ability to work in multilingual environments and match you with roles that require specific language expertise.",
    languages_hobby_id: "Select your hobbies and interests to show a well-rounded personality. Employers appreciate candidates with diverse interests, and this can help you stand out as a unique fit for the company culture.",
    career_preference_soft_skill_id: "Select the key soft skills you are good at.",
    career_preference_set_industry_apart: "Describe what makes you unique in your field (max 200 characters). Highlighting your unique skills and experiences helps employers recognize your value and improves your chances of being selected. Only alphabets are allowed.",
    career_preference_professional_strength_id: "Select your strongest professional trait. Showcasing a key strength can help employers recognize the value you'll bring to their team, improving your chances of landing the right role.",
    career_preference_real_world_challenge: "Demonstrate your problem-solving skills! Employers value candidates who can apply their expertise to practical situations. Only alphabets are allowed, up to 200 characters.",
    career_preference_leadership_experience: "Demonstrate if you've taken leadership roles to show your potential to lead. Leadership experience can greatly increase your chances of being considered for higher-level positions. Only alphabets are allowed, up to 200 characters.",
    career_preference_admired_quality: "Highlight a trait that colleagues or peers appreciate most. This helps employers understand your character and work ethic. Only alphabets are allowed, up to 100 characters.",

    // Networking & Portfolio
    networking_linkedin_profile: "Share your LinkedIn profile to provide employers with easy access to your professional background and network. A complete LinkedIn profile can increase your chances of being noticed by employers and expand your opportunities.",
    networking_social_media: "Select the social media handles you want to showcase and build your personal brand. Click here to add them!",
    networking_social_media_link: "Include links to your professional social media accounts to showcase your personal brand. Employers may check these profiles to get a better sense of your expertise and interests.",
    networking_personal_website: "Link to your personal website or portfolio to provide employers with a detailed view of your work. A well-curated online portfolio can increase your chances of standing out and landing your desired role.",
    career_preference_cv_filename: "Upload your CV or resume in pdf or all image format to give employers a detailed view of your professional background. A well-structured resume is key to making a great first impression and increasing your chances of landing an interview.",
    career_preference_video_link: "Upload a brief video introduction link to showcase your personality, communication skills, and passion. A compelling video can make you stand out and increase your chances of being remembered by employers.",
    career_preference_portfolio_upload_link: "Upload your portfolio to demonstrate your work. Showcasing your best work can significantly boost your chances of getting hired.",
  ...
  onSubmit() {
    ...
    if (this.personalInfoForm.valid) {   
      ...
      if (isUpdateOperation) {
        ...
        formData.append('profile_completion', this.profileCompletion.toString());
        formData.append('total_years_of_experience', this.personalInfoForm.get('total_years_of_experience')?.value || '');
        this.educationDetails.controls.forEach((control, index) => {
          const education = control as FormGroup;
        ...
        formData.append('career_preference_career_interest_id', JSON.stringify(this.personalInfoForm.get('career_preference_career_interest_id')?.value) || '');
        formData.append('career_preference_preferred_work_location_id', JSON.stringify(this.personalInfoForm.get('career_preference_preferred_work_location_id')?.value) || '');
        formData.append('career_preference_preferred_employment_type', JSON.stringify(this.personalInfoForm.get('career_preference_preferred_employment_type')?.value) || '');
        formData.append('career_preference_preferred_workplace_type', JSON.stringify(this.personalInfoForm.get('career_preference_preferred_workplace_type')?.value) || '');
  ...
  private appendIfModified(
    ...
    const formattedValue = Array.isArray(transformedValue)
      ? JSON.stringify(transformedValue)
      : transformedValue;

    const baseFieldName =
      fieldName.replace(/\[\d+\]/g, '').split('[').pop()?.replace(']', '') ||
      fieldName;
    ...
    const formattedOriginalValue = Array.isArray(originalValue)
  ...
  patchFormData(response: any) {
    ...
    this.personalInfoForm.patchValue({
      ...
      career_preference_professional_strength_id: (Array.isArray(response.careerPreference?.professional_strength_id) ? response.careerPreference?.professional_strength_id : [response.careerPreference?.professional_strength_id]) || [],
