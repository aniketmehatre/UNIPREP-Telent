...
export class TalentConnectService {
    ...
    getCountries() {
        return this.http.post<any>(environment.ApiUrl + "/getcountryandcurrency", { headers: this.headers });
    }
    ...
    getJobList(data: any) {
        return this.http.post<any>(environment.ApiUrl + "/getuserJobList", data, { headers: this.headers });
    }

    getJobDetails(id: number) {
        return this.http.post<any>(environment.ApiUrl + "/showuserJobs", { id: id }, { headers: this.headers });
    }

    applyJob(id: number) {
        return this.http.post<any>(environment.ApiUrl + "/saveeasyapplyjob", { job_id: id }, { headers: this.headers });
    }

    getAppliedJobList(data: any) {
        return this.http.post<any>(environment.ApiUrl + "/getusertracklist", data, { headers: this.headers });
    }

    getJobTrackerDetail(id: number) {
        return this.http.post<any>(environment.ApiUrl + "/showuserTrack", { id: id }, { headers: this.headers });
    }

    sendMessage(formData: FormData) {
        return this.http.post<any>(environment.ApiUrl + "/sendMessage", formData, { headers: this.headers });
    }

    getMessage(data: { job_id: number }) {
        return this.http.post<any>(environment.ApiUrl + "/getMessage", data, { headers: this.headers });
    }

    getDepartmentData() {
        return this.http.get<any>(environment.ApiUrl + "/getdepartments", { headers: this.headers });
    }

    getJobAiSummary(data: any) {
        return this.http.post<any>(environment.ApiUrl + "/jobChatAiGenerate", data, { headers: this.headers });
    }
    ...
    getCompanyChatAiSummary(data: any) {
        return this.http.post<any>(environment.ApiUrl + "/airephrase", data, { headers: this.headers });
    }
    ...
    getTalentConnectCompanies(formValues: any) {
        const headers = new HttpHeaders().set("Accept", "application/json");
        return this.http.post<any>(environment.ApiUrl + "/gettalentconnectcompanies", formValues, { headers: headers });
    }
    ...
    getCompanyDetails(id: any) {
        ...
        const headers = new HttpHeaders().set("Accept", "application/json");
        return this.http.post<any>(environment.ApiUrl + "/getcompanydetails", formData, { headers: headers });
    }
    ...
    getCurrencies() {
        return this.http.get<any>(environment.ApiUrl + "/currenciesList", { headers: this.headers });
    }
    ...
    getCompanyConnectAiSummary(formData: any) {
        return this.http.post<any>(environment.ApiUrl + "/companyChatAiGenerate", formData, { headers: this.headers });
    }
