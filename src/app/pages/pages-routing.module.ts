...
import { TalentSupportComponent } from "./talent-support/talent-support.component";
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: "language-hub",
        loadChildren: () =>
          import("./language-hub/language-hub.module").then(
            (m) => m.LanguageHubModule
          ),
      },
      {
        path: "subscriptions",
      ...
      },
      {
        ...
        loadChildren: () =>
          import(
            "./footersection/termsandcondition/termsandcondition.module"
          ).then((m) => m.TermsAnsConditionModule),
      },
      {
        path: "privacypolicy",
      ...
      },
      {
        ...
        loadChildren: () =>
          import("./recentlyaddedquestions/recentlyaddedques.module").then(
            (m) => m.RecentlyAddedQuestionsModule
          ),
      },
      {
        path: "support",
      ...
      },
      {
        path: "founderstool",
        loadChildren: () =>
          import("./founderstool/founderstool.module").then(
            (m) => m.FounderstoolModule
          ),
      },
      {
      ...
      },
      {
        path: "unilearn",
        loadChildren: () =>
          import("./unilearn/unilearn.module").then((m) => m.UniLearnModule),
      },
      {
        path: "advisor",
      ...
      },
      {
        path: "travel-tools",
        loadChildren: () =>
          import("./travel-tools/travel-tools.module").then(
            (m) => m.TravelToolsModule
          ),
      },
      {
        path: "education-tools",
        loadChildren: () =>
          import("./education-tools/education-tools.module").then(
            (m) => m.EducationToolsModule
          ),
      },
      {
      ...
      },
      {
        path: "career-hacks",
        loadChildren: () =>
          import("./career-hacks/careerhacks.module").then(
            (m) => m.CareerHacksModule
          ),
      },
      {
      ...
      },
      {
        path: "salary-hacks",
        loadChildren: () =>
          import("./salary-hacks/salaryhacks.module").then(
            (m) => m.SalaryHacksModule
          ),
      },
      {
      ...
      },
      {
        ...
        loadChildren: () =>
          import(
            "./job-seeker-success-stories/job-seeker-success-stories.module"
          ).then((m) => m.JobSeekerSuccessStoriesModule),
      },
      {
        path: "fortune-companies",
        loadChildren: () =>
          import("./fortune-companies/fortune-companies.module").then(
            (m) => m.FortuneCompaniesModule
          ),
      },
      {
      ...
      },
      {
        path: "talent-connect",
        loadChildren: () =>
          import("./talent-connect/talent-connect.module").then(
            (m) => m.TalentConnectModule
          ),
      },
      {
        ...
        loadChildren: () =>
          import(
            "./talent-connect/company-connect/company-connect.module"
          ).then((m) => m.CompanyConnectModule),
      },
      {
        path: "global-repo",
      ...
      },
      {
        ...
        loadChildren: () =>
          import(
            "./global-employment-insights/global-employment-insights.module"
          ).then((m) => m.GlobalEmploymentModule),
      },
      {
      ...
      {
        path: "talent-support",
        component: TalentSupportComponent,
      },
    ],
  },
];
