...
const routes: Routes = [
  { 
    ...
    children: [
      ...
      { path: 'pre-application', canActivate:[PagesGuard], loadChildren: () => import('./pre-application/pre-application.module').then(m => m.PreApplicationModule)  },
      { path: 'post-application',canActivate:[PagesGuard], loadChildren: () => import('./post-application/post-application.module').then(m => m.PostApplicationModule)  },
      { path: 'post-admission',canActivate:[PagesGuard], loadChildren: () => import('./post-admission/post-admission.module').then(m => m.PostAdmissionModule)  },
      { path: 'career-hub',canActivate:[PagesGuard], loadChildren: () => import('./career-hub/career-hub.module').then(m => m.CareerHubModule)  },
