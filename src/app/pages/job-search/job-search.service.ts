...
export class JobSearchService {
  ...
  searchJobs(query: any): Observable<any> {
    ...
    return this.http.get(
      `${this.apiUrl}/${query.location}/search/${query.page}`,
      { params }
    );
  }
  ...
  fetchCategory(query: any): Observable<any> {
    let params = new HttpParams()
      .set("app_id", this.appId)
      .set("app_key", this.appKey);
    return this.http.get(`${this.apiUrl}/${query.location}/categories`, {
      params,
    });
  }
  ...
  getJobTracker() {
    ...
    return this.http.post<any>(
      environment.ApiUrl + "/getjobtracker",
      {},
      {
        headers: headers,
      }
  ...
  updateJobStatusList(values: any) {
    const headers = new HttpHeaders().set("Accept", "application/json");
    return this.http.post<any>(
      environment.ApiUrl + "/updatejobtracker",
      values,
      {
        headers: headers,
      }
  ...
  deletejobtracker(values: any) {
    const headers = new HttpHeaders().set("Accept", "application/json");
    return this.http.post<any>(
      environment.ApiUrl + "/deletejobtracker",
      values,
      {
        headers: headers,
      }
  ...
  getCities() {
    ...
    return this.http.post<City[]>(
      environment.ApiUrl + "/getcitywithflag",
      { module: "job_portal" },
      { headers: headers }
    );
  }
  ...
  getCountryCurrencyChatGptOutput(data: any) {
    const headers = new HttpHeaders().set("Accept", "application/json");
    return this.http
      .post<any>(environment.ApiUrl + "/getIntegratedRecom", data, {
        headers: headers,
      })
      .pipe(
  ...
  getTripList(type: string) {
    ...
    return this.http.get<any>(
      environment.ApiUrl + `/userSavedResponse?mode=${type}`,
      {
        headers: headers,
      }
    );
  ...
  downloadRecommendation(data: any) {
    ...
    return this.http.post<{ url: string }>(
      environment.ApiUrl + "/downloadIntegratedRecom",
      data,
      {
        headers: headers,
      }
